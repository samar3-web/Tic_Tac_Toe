...
public class ChoosePlayMode extends AppCompatActivity implements View.OnTouchListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        WithAFriendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChoosePlayMode.this,PlayWithFriend.class);
        ...
        WithAi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChoosePlayMode.this,PlayWithRobot.class);
                startActivity(intent);
            }
        });
