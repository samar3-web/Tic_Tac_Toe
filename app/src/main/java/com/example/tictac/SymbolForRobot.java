...
public class SymbolForRobot extends AppCompatActivity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_symbol_for_robot);
        ...
        ContinueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SymbolForRobot.this,AiGameActivity.class);
